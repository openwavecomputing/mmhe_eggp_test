  ...
  render() {
    if(this.state.loading){
        ...
        <>
            ...
            <button type="button" id="btn" className="btn btn-create-request" onClick={this.viewGGPForm}>
            <i className="fa fa-eye p_5"></i>
            <span className="cr-text">&nbsp;View GGP Form </span>
        </button>
        </>
        );
    }
