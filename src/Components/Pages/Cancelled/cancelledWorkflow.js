...
class cancelledWorkflow extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    this.props.dispatch({ type: "headerTitle", value: ((this.state.Referenceno) ? "Cancelled : WorkFlow - " + this.state.Referenceno : "Cancelled : WorkFlow")});
    let encryptedId = this.props.location.search;
    var CryptoJS = require("crypto-js");
...
export default connect(mapStateToProps)(cancelledWorkflow);