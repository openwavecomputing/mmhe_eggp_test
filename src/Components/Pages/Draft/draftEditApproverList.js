...
toast.configure();
class draftEditApproverList extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <>
        <Breadcrumb>
          ...
          <Breadcrumb.Item href={process.env.REACT_APP_ENV +"/draft/list"}>Edit Request</Breadcrumb.Item>
      ...
      <table className="table table-hover">
        ...
        <tbody>
                      ...
                      <div className="form-group row">
                        <div className="col-sm-8">
                          <div className="input-group mb-2 mr-sm-2" >
                            <input type="text" onClick={() => this.editApprover(loopdata.Workflowid)} className="form-control" id="" placeholder="" readOnly={true} value={this.state.RequesterDisplayName} />
          ...
          <tr style={{display: this.state.canaddsecondApprover}}>
            ...
            <td></td>
            <td></td>
            {/*<td> <div className="badge badge-approver-pending">Pending</div> </td>
            <td> <input className="form-control" type="text" placeholder="" name="Comments" value={this.state.Comments} onChange={this.handleChange}/> </td> */}
            <td>
        ...
        <div className="text-center text-sm-right">
          {(() => {
              if (this.state.canEnableSave === "no") {
                ...
                return (
                  <button className="btn btn-primary-01 ml-3 float-right float-sm-none mr-4" type="button" onClick={this.save}>
                  <i className="fa fa-save"> </i> <span className="d-none d-sm-inline">  Submit </span>
                  </button>
                )
              }
...
export default connect(mapStateToProps)(draftEditApproverList);
