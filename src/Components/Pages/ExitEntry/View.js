...
class approvedView extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch({ type: 'headerTitle', value: "View : Request - " + this.state.Referenceno })
    this.getGGPRequest();
  }
  ...
  render() {
    if(this.state.loading){
        return (
            ...
            <Breadcrumb.Item href={process.env.REACT_APP_ENV +"/exitentry/list"}>GGP Exit & Entry</Breadcrumb.Item>
...
export default connect(mapStateToProps)(approvedView);