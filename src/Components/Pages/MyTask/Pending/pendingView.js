...
class pendingView extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch({ type: 'headerTitle', value: "Pending : View" })
    this.getGGPRequest();
  }
  ...
  render() {
    if(this.state.loading){
        return (
            ...
            <Breadcrumb.Item href={process.env.REACT_APP_ENV +"/mytask/pending/list"}>My Task : Pending List</Breadcrumb.Item>
...
export default connect(mapStateToProps)(pendingView);