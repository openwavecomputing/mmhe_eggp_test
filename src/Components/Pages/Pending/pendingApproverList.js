...
toast.configure();
class pendingApproverList extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <>
        <Breadcrumb>
          ...
          <Breadcrumb.Item href={process.env.REACT_APP_ENV +"/pending/list"}>Edit Request</Breadcrumb.Item>
...
export default connect(mapStateToProps)(pendingApproverList);
