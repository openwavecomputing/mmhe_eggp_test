...
class pendinggoodsreturnView extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    this.props.dispatch({ type: 'headerTitle', value: "Pending Goods Return: View" })
    this.getGGPRequest();
  }
...
export default connect(mapStateToProps)(pendinggoodsreturnView);