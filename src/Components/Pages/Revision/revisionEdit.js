...
class revisionEdit extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch({ type: "headerTitle", value: ((this.state.Referenceno) ? "Revision : Edit - " + this.state.Referenceno : "Revision : Edit")});
  ...
  GetAttachmentslistData = () =>{
    ...
    .then(data => {
      ...
      //console.log(data)
      if(data){
        this.setState({ AttachmentslistArray: data.AttachmentsList })
      }
    })
  }
  saveasdraf = () =>{
  ...
  handleChange = (e) => {
    ...
    switch (e.target.name) {
      ...
      case "GoodsItem_Qtyunit":
        this.setState({ GoodsItem_Qtyunit: e.target.value })
        break;
      ...
      case "GoodsItem_Edit_Qtyunit":
        this.setState({ GoodsItem_Edit_Qtyunit: e.target.value })
        break;
  ...
  GetReferenceLinkslistData = () =>{
    ...
    .then(data => {
      ...
      //console.log(data)
      if(data){
        this.setState({ ReferenceLinkslistArray: data.ReferenceLinkList })
      }
    })
  }
  ...
  saveGoodsCategory = () =>{
    ...
    let postData = { 
      ...
      Returndate: this.state.Icnumber,
  ...
  saveDraftRequesterInformation =() =>{
    ...
    if(data){
        ...
        this.setState({ issaveGoodsCategory: "yes" })
        toast.success("Request saved as a draft successfully.", {
          position: toast.POSITION.TOP_CENTER,
          autoClose: 2000,
        });
        this.props.history.push({ pathname: "/draft/list" });
          ...
          if (this.validator3.allValid()) {
            if (this.state.GoodsItemslistArray.length >= 1) {
              ...
              if(this.state.AttachmentslistArray.length > 0 ){
                ...
                window.location = process.env.REACT_APP_ENV +"/revision/approverlist?p=" + encodeURI(CryptoJS.AES.encrypt(JSON.stringify(this.state.Referenceno), process.env.REACT_APP_ENCRYPT_PASSWORD).toString());
              }
            }else{
  ...
  render() {
    ...
    let cPopover = ""
   if(this.state.RequesterDisplayName){
      cPopover = (
      `<div class="pop">
        <div class="row">
    ...
    return (
      <>
        <Breadcrumb>
          ...
          <Breadcrumb.Item href={process.env.REACT_APP_ENV +"/revision/list"}>Revision List</Breadcrumb.Item>
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-4">
                <div className="input-group mb-2 mr-sm-2" >
                  <input type="text" onClick={this.showFirstStaffPopup} className="form-control" id="" placeholder="" readOnly={true} value={this.state.RequesterDisplayName} />
                ...
                return (
                  ...
                  <div className="form-group row mb-2">
                    ...
                    <div className="col-sm-2">
                      <div className="form-group">
                        <input type="text" className="form-control" readOnly={true} value={this.state.Authorizedid} onClick={this.showSecondAuthorizedNamePopup} />
                      </div>
                      ...
                      <div className="input-group mb-2 mr-sm-2" >
                        ...
                        <div className="input-group-prepend">
                          <div className="input-group-text">
                            <i className="fa fa-search text-muted" onClick={this.showSecondAuthorizedNamePopup}> </i>
                          </div>
                        </div>
                      </div>
                      </div>
      ...
      {(() => {
        if (this.state.Goodscategory === "Returnable") {
          ...
          <div className="form-group row">
            ...
            <div className="col-sm-4">
              <div className="input-group mb-2 mr-sm-2">
                <DatePicker format="dd-MM-y" onChange={this.Returndate}  className="date-picker-style form-control" value={this.state.Returndate}
                />
              </div>
            ...
            <table className="table table-hover">
              ...
              <tbody>
                ...
                <tr style={{display: this.state.GoodsItemAdd }}>
                  <td>  </td>
                  <td> <input className="form-control" type="number" placeholder="Qty"  style={{minWidth:"50px"}} name="GoodsItem_Qtyunit" value={this.state.GoodsItem_Qtyunit} onChange={this.handleChange} /> </td>
                ...
                <tr style={{display: this.state.GoodsItemAdd }}>
                  ...
                  <td>  </td>
                  {/* <td> { this.validator5.message('Quantity to be Return', this.state.GoodsItem_Qtyreturn, 'required')} </td> */}
          ...
          <Modal.Body>
            <section className="p-3">
              <div className="form-group row mb-1">
                ...
                <div className="col-sm-6">
                  <div className="form-group">
                    <input type="text" className="form-control" name="GoodsItem_Edit_Qtyunit" value={this.state.GoodsItem_Edit_Qtyunit} onChange={this.handleChange}/>
                  </div>
                </div>
              </div>
              <div className="form-group row mb-1">
