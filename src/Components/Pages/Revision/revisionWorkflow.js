...
class revisionWorkflow extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    this.props.dispatch({ type: "headerTitle", value: ((this.state.Referenceno) ? "Revision : WorkFlow - " + this.state.Referenceno : "Revision : WorkFlow")});
    let encryptedId = this.props.location.search;
    var CryptoJS = require("crypto-js");
...
export default connect(mapStateToProps)(revisionWorkflow);