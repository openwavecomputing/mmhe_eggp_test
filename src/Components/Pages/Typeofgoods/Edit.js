...
class Edit extends Component {
  ...
  componentDidMount() {
    ...
    var decryptedId = JSON.parse(bytes.toString(CryptoJS.enc.Utf8));
    let postData = { ID: decryptedId }
    this.setState({ editId: decryptedId })
    ...
    .then(data => {
      //console.log(data)
      // //console.log(data.GoodsTypeList[0].Goodstype)
      if(data){
        this.setState({ 
          Goodstype: data.GoodsTypeList[0].Goodstype,
          Verifierid: data.GoodsTypeList[0].Verifierid,
          Verifiername: data.GoodsTypeList[0].Verifiername,
          Approverid: data.GoodsTypeList[0].Approverid,
          Approvername: data.GoodsTypeList[0].Approvername,
          Active: data.GoodsTypeList[0].Active,
         })
         if(data.GoodsTypeList[0].Verifierid){
          this.setState({ 
            canRemoveVerifier: "",
           })
          }else{
    ...
    this.props.dispatch({ type: "headerTitle", value: "Type Of Goods: Edit" });
                ...
                <tbody>
                  {this.state.StaffDetailslistArray.map((staff, index) => (  
                      <tr onClick={()=>this.getVerifierDetails(staff.EmployeeId, staff.Name)}   className="cursor-pointer">  
                        <td> <p> <span className="material-icons-outlined"> how_to_reg </span> </p> </td>
           ...
           <div className="form-group row">
            ...
            <div className="form-group row mb-2">
              ...
              <div className="col-sm-2">
                <div className="form-group">
                  <input type="text" className="form-control" id="TxtVrfyId" readOnly={true} onClick={this.getVerifiershow} value={this.state.Verifierid}/>
                </div>
              </div>
              <div className="col-sm-3">
                <div className="form-group">
                <div className="input-group mb-2 mr-sm-2" >
                  <input type="text" onClick={this.getVerifiershow} className="form-control" id="TxtVrfy" placeholder="" readOnly={true} value={this.state.Verifiername}/>
