...
class pendingconfirmgoodsreturnWorkflow extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    this.props.dispatch({ type: "headerTitle", value: ((this.state.Referenceno) ? "Pending Confirm Goods Return : WorkFlow - " + this.state.Referenceno : "Pending Confirm Goods Return : WorkFlow")});
    let encryptedId = this.props.location.search;
    var CryptoJS = require("crypto-js");
...
export default connect(mapStateToProps)(pendingconfirmgoodsreturnWorkflow);